...
const { imagetype, imageUpload, imageUploadPage, deleteimage, uploadPrincipal, uploadSecretary, uploadDirector, uploadIncharge, uploadLogo, uploadNotice, uploadNews } = require('../controllers/image-handling')
...
app.post('/upload-image', sliderStorage.single('slider'),sliderMiddlerware, imageUpload)
app.post('/upload-principal', principalStorage.single('principal'),principalMiddleware, uploadPrincipal)
app.post('/upload-director', principalStorage.single('principal'),principalMiddleware, uploadDirector)
app.post('/upload-secretary', principalStorage.single('principal'),principalMiddleware, uploadSecretary)
app.post('/upload-principal', principalStorage.single('principal'),principalMiddleware, uploadPrincipal)
app.post('/upload-incharge', principalStorage.single('principal'),principalMiddleware, uploadIncharge)
app.post('/upload-logo', principalStorage.single('principal'),principalMiddleware, uploadLogo)
app.post('/add-notice', noticeStorage.single('notice'),noticeMiddleware, uploadNotice)
